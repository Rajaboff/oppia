...
"""Python configuration for ButtonChoiceInput interaction."""
...
class ButtonChoiceInput(base.BaseInteraction):
    """Interaction for Button choice input."""

    name = 'Button Choice'
    description = (
        'Allows learners to select one of a list of Button-choice options.')
    ...
    _customization_arg_specs = [{
        'name': 'choices',
        'description': 'Button Choice options',
        'schema': {
            'type': 'list',
            'validators': [{
            ...
            'ui_config': {
                'add_element_text': 'Add Button choice option',
            }
        },
        'default_value': [{
            'content_id': None,
