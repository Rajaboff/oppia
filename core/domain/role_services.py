...
ACTION_CHANGE_PAID_STATUS_ANY_ACTIVITY = 'CHANGE_PAID_STATUS_ANY_ACTIVITY'
ACTION_PLAY_ANY_PAID_ACTIVITY = 'PLAY_ANY_PAID_ACTIVITY'
...
ROLE_ACTIONS = {
    feconf.ROLE_ID_ADMIN: [
        ...
        ACTION_CHANGE_PAID_STATUS_ANY_ACTIVITY,
        ACTION_PLAY_ANY_PAID_ACTIVITY,
